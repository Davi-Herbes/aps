...
$dados_estagios = Estagio::findByProfessor($professor->id);
...
<head>
  ...
  <link rel="stylesheet" href="/2025/projeto/grupo2/pages/home/professor/listagem_estagios/styles.css">
...
<body>
  ...
  <div class="page-container">
    ...
    <section class="main-section">
      ...
      <!-- <h2 class="main-section-title">Estágios dos seus orientandos</h2> -->
      <ul class="estagios">
          ...
          <li class="estagio-card">
            <a href="/2025/projeto/grupo2/?e=<?= $estagio->id ?>">
              <div class="estagio-card-item main">
                <div class="user-img">
                  <img src="/2025/projeto/grupo2/public/imgs/user-icon.svg" alt="asdf">
                </div>
                <div class="user-description">
                  <h2 class="item-title"><?= $usuario->nome ?></h2>
                  <div class="item-description"><?= $curso->nome ?? "-------" ?></div>
                </div>
              </div>
