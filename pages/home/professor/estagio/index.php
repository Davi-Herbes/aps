...
$estagio_id = $_GET["e"];
$result = Estagio::findJoinAlunoUsuarioDocumento($estagio_id);
...
<head>
  ...
  <link rel="stylesheet" href="/2025/projeto/grupo2/pages/home/professor/estagio/styles.css">
  <link rel="stylesheet" href="/2025/projeto/grupo2/pages/home/professor/estagio/documentos.css">
    ...
    <aside class="main-aside">
      <nav class="aside-nav">
        <ul>
          ...
          <li>
            <a href="/2025/projeto/grupo2/pages/cadastro_estagio">
              <figure>
        ...
        <div class="estagio-container">
          <div class="title-container">
            ...
            <div class="title-btn-container">
              <button id="submit-estagio-btn" disabled type="button">Enviar</button>
              <form method="post" action="/2025/projeto/grupo2/src/forms/deletar_estagio.php" onsubmit="return confirm('Tem certeza que deseja deletar este estágio?');">
                <input type="hidden" name="estagio_id" value="<?= $estagio->id ?>">
                <button type="submit" class="delete-estagio-btn">Deletar Estágio</button>
              </form>
            </div>
          </div>
          <form id="estagio-form" method="POST" action="/2025/projeto/grupo2/src/forms/atualizar_estagio.php?estagio_id=<?= $estagio_id ?>" class="estagio-data">
            <div class="estagio estagio-data-card">
              ...
              <div class="field">
                ...
                <input id="hora_semana" name="hora_semana" type="number" class="field-value" value="<?= $estagio->hora_semana ?>" placeholder="20" min="1">
              </div>
        ...
        <div class="related-data">
          ...
          <div class="data-card">
            ...
            <div>
              ...
              <?= DateTime::createFromFormat("Y-m-d", $usuario->data_nasc)->format("d/m/Y") ?>
            </div>
            <div>
              <span class="field-name">
                CPF:
          ...
          <div class="data-card">
            ...
            <div>
              ...
              <?= $professor->user->nome . " " . $professor->user->sobrenome ?>
            </div>
            <div>
              <span class="field-name">
                CPF:
        ...
        <div class="documentos">
          <div class="title-container">
            ...
            <div class="title-btn-container">
              ...
              <!-- <button class="submit-documento update-btn">Enviar Alterações</button> -->
            </div>
          </div>
            ...
            <div class="doc">
              ...
              <form id="docs-form" class="upload-form" action="/2025/projeto/grupo2/src/forms/enviar_documento.php" method="post" enctype="multipart/form-data">
                ...
                <div class="upload-form-item">
                  ...
                  <?php else:  ?>
                    <div class="file-upload-text-empty">Nenhum envio foi feito ainda</div>
                  <?php endif;  ?>
                ...
                <label class="upload-form-item">
                  ...
                  <?php else:  ?>
                    <div class="file-upload-text-empty">Vazio</div>
                  <?php endif;  ?>
                </label>
